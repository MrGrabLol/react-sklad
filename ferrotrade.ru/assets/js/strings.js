    ...
    if (data.length !== 0) {
        if (data[0].mass.length === 1) {
            ...
            for (i = 0; i < data.length; i++) {
               ...
               <td>${data[i].packing}</td><td>${data[i].mass[0].toFixed(2)}</td></tr>`;
            }
            ...
            <tr>
               ...
               <th scope="col">Диаметр</th>
               <th scope="col">Упаковка</th>
               <th scope="col">Солнечногорск</th>
               <th scope="col">Белорецк</th>
            </tr>
            </thead>
            <tbody>`;
            for (i = 0; i < data.length; i++) {
                products += `<tr><th>${i + 1}</th><td>${data[i].mark}</td><td>${data[i].diameter}</td>
               <td>${data[i].packing}</td><td>${data[i].mass[0].toFixed(2)}</td>
               <td>${data[i].mass[1].toFixed(2)}</td></tr>`;
            }
            products += '</tbody></table></div>';
            return products;
        }
