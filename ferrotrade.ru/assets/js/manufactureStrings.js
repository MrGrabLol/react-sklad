function table(data){
 ...
 {
     return `<div class="col-md-4 p-1"><a href="product.html?id=${id}" class="card product col-12 p-md-3 p-2" id="${id}">
 ...
 {
     return `<div class="col-md-4 col-sm-6 col-6 p-1"><a href="product.html?id=${id}" class="card product col-12 p-md-3 p-2" target="_blank" id="${id}">
         <div class="card-body p-1">
             <div class="col-12 text-center">Позиция</div>
             <p class="card-text">Марка: ${mark}</p>
             <p class="card-text">Диаметр: ${diameter}</p>
 ...
 {
     return `<div class="col-md-4 col-sm-6 col-6 p-1"><a href="package.html?id=${id}" class="card product col-12 p-md-3 p-2" target="_blank" id="${id}">
         <div class="card-body p-1"> 
 ...
 function card_to_print(id)
 {
    ...
    $.ajax({
       type: 'GET',
       url: `${curHost}/api/manufacture/position/${id}`,
       dataType: 'json',
       async: false,
