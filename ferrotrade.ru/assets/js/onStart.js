        ...
        <form name="updForm">
          <div class="form-group">
            ...
            <div class="row">
              ...
              <textarea class="form-control" id="updComment" name="updComment" rows="3" style="margin-top: 0; margin-bottom: 0; height: 79px;"></textarea>
            </div>
          </div>
        </form>
                    ...
                    <div class="form-group">
                        ...
                        <span class="row pl-3">
                          ...
                          <input class="addManyFormCheck mt-2 ml-2" id="mark" name="addManyFormCheck" type="checkbox">
                                ...
                                oninput='help_mark();' disabled name="markMany" placeholder="" required="" type="text" value="">
                            </div>
                            <div class="col-md-6 mb-3">
                        <span class="row pl-3">
